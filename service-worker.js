const CACHE='ayi-v2';
const ASSETS=['./','./index.html','./css/style.css','./js/app.js','./data/users.json','./data/students.json','./data/teachers.json','./data/rooms.json','./data/timetable.json','./data/publications.json','./data/chatbot.json','./data/prepa/semester1.json','./data/prepa/semester2.json','./assets/building/building-general.jpg','./assets/building/building-exploded.jpg','./assets/building/building-cutaway.jpg','./assets/building/timetable-demo.jpeg','./manifest.json'];
